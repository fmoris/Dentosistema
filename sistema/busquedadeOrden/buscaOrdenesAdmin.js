 dentosys.controller('buscaOrdenesAdmin', function($scope, $http, toaster, $window, $filter, $q, ngTableParams, $location, $route, $timeout) {
    ...
    /*if (screen.width <= 800) {        
        $location.path('/buscaOrdenesAdminMovil');
    }*/
    $scope.listaOrdenes = function(){
     ...
     $scope.edita = function(tipo, orden) {
        /*console.log(tipo);*/
         switch (tipo) {
             case 'PROTESIS FIJA':
                /* $location.path('/editarProtesisFija').search({*/
                 $location.path('/editarProtesisFija').search({
                     orden: orden
                     /*tipo: 1*/
                 });
