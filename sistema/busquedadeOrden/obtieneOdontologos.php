...
/// CONECTA A LA BASE DE DATOS
    ...
    /*if(!$_GET['platoID']){
 	...
 	$result = mysqli_query($conexion,"SELECT nombrecompleto,rut FROM usuario WHERE es_odontologo LIKE 1 order by nombrecompleto"); 	
	...
	while($row = mysqli_fetch_array($result)){
        ...
        // crea un objeto donde se incluyen los datos del registro
	   	$objetoOrigen = array();
	   	$objetoOrigen["nombrecompleto"] = $row['nombrecompleto'];	 
