 dentosys.controller('protesisFija' , function($scope, $http, toaster, $window, $routeParams, $location){ 
...
/// Guardar Formulario
     $scope.envio = function(){        
        $http.post('sistema/ordenes/protesisFija/nuevaPF.php', $scope.orden)        
