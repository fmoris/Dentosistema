 dentosys.controller('nuevoEstadoOrden', function($scope, $http, toaster, $window, $routeParams, $location) {
     ...
     $scope.envio = function() {        
         $http.get('sistema/mantencion/estados/estadoOrden/nuevoEstado.php', {
             params: {
