...
$result = mysqli_query($conexion,"SELECT DISTINCT orden.IDODONTOLOGO, odontologo.NOMBREOD FROM orden, odontologo WHERE orden.IDODONTOLOGO = odontologo.IDODONTOLOGO AND orden.ESTADO = 'terminado' AND orden.PAGADO = 'no pagado' ORDER BY odontologo.NOMBREOD");
