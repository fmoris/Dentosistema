...
$origenQuery = mysqli_query($conexion,"SELECT NOMBREOD
 										  FROM odontologo
 										  WHERE IDODONTOLOGO = $id");

$result = mysqli_query($conexion,"SELECT NUMORDEN,NOMCLASIF,PACIENTE,FECHARECEPCION,FECHAENTREGA,ESTADO,PAGADO,INSTITUCION,CLASIFICACION,TOTALORDEN
            ...
            $resultadoOrdenado["nombre"] = mysqli_fetch_array($origenQuery)['NOMBREOD'];
			...
			while($row = mysqli_fetch_array($result)){
				...
				$objetoOrigen["origen"] = $row['INSTITUCION'];
